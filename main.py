...
vk_token = "f137b751c95ec29242acfe8b7ecfc65aa4ee79ec55fa226951b44edd474a5ce697cbc9f66d25626d229f7"
# Сюда вставляешь свой токен. (Я юзал от кейта. Получить можно тут https://vkhost.github.io )

contest_trigger_list = ('жопа')  # Листик слов триггеров для уведомления о розыгрыше:
...
start_my_contest_trigger = (
    "конкурс"  # Вводишь в кавычках команду, с которой начинается свой розыгрыш.
)
trigger_word = (
    "ой"  # Триггер слово в кавычках, с маленькой буквы для удаления сообщений.
)

layout_swap_trigger = (
    "бля"  # Триггер слово в кавычках, с маленькой буквы для смены раскладки на последнем сообщении.
)
...
mention_answer_list = (
    "Катовский",  # Триггер для автоответчика в кавычках;
    [17673, 21454],  # [1, 2, 3] - Заполняете в скобках id стикеров для ответа;
    True,  # Установите True, чтобы использовать упоминание как дополнительный триггер (наприм. @durov)
    300  # Минимальное время (в секундах) между старой и новой "реакцией" на сообщение
)
